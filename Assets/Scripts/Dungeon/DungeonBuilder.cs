...
public class DungeonBuilder : SingletonMonobehaviour<DungeonBuilder>
{
    ...
    private bool ProcessRoomsInOpenRoomNodeQueue(RoomNodeGraphSO roomNodeGraph, Queue<RoomNodeSO> openRoomNodeQueue, bool noRoomOverlaps)
    {
        while (openRoomNodeQueue.Count > 0 && noRoomOverlaps)
        {
            ...
            else
            {
                ...
                noRoomOverlaps = CanPlaceRoomWithNoOverlap(roomNode, parentRoom);
            }
        }
    ...
    private bool CanPlaceRoomWithNoOverlap(RoomNodeSO roomNode, Room parentRoom)
    {
        ...
        while (roomOverlaps)
        {
            ...
            Doorway doorwayParent = unconnectedAvailableDoorways[Random.Range(0, unconnectedAvailableDoorways.Count)];
