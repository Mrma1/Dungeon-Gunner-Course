...
public class AStarTest : MonoBehaviour
{
    ...
    private Grid grid;
    private Tilemap frontTilemap; //复制前网格
    ...
    {
        if (position.x < instantiatedRoom.room.templateLowerBounds.x || position.x > instantiatedRoom.room.templateLowerBounds.x ||
            position.y < instantiatedRoom.room.templateLowerBounds.y || position.y > instantiatedRoom.room.templateLowerBounds.y)
        {
            return false;
        }
        else
