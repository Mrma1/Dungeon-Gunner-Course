...
public class MovementToPosition : MonoBehaviour
{
	...
	{
		Vector2 unitVecotr = Vector3.Normalize(movePosition - currentPosition);

		rigidBody2D.MovePosition(rigidBody2D.position + (unitVecotr * moveSpeed * Time.fixedDeltaTime));
	}
}
