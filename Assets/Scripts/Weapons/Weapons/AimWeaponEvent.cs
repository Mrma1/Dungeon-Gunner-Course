...
{
	public event Action<AimWeaponEvent, AimWeaponEventArgs> OnWeapoAim;
	...
	{
		OnWeapoAim?.Invoke(this, new AimWeaponEventArgs() { aimDirection = aimDirection, aimAngle = aimAngle, weaponAimAngle = weaponAimAngle, 
