...
public class WeaponDetailsSO : ScriptableObject
{
    ...
    [Header("无限弹药")] public bool hasInfiniteAmmo = false;
    [Header("无限弹药容量")] public bool hasInfiniteClipCapacity = false;
    [Header("一次弹夹容量")] public int weaponClipAmmoCapacity = 6;
    [Header("总弹药容量")] public int weaponAmmoCapacity = 100;
    [Header("武器射速")] public float weaponFireRate = 0.2f;
    [Header("射击间隔")] public float weaponPrechargeTime = 0f;
    [Header("弹药填充速度")] public float weaponReloadTime = 0f;
