...
public class AmmoDetailsSO : ScriptableObject
{
    ...
    [Header("弹药填充时间")] public float ammoChargeTime = 0.1f;
    [Header("弹药填充材质")] public Material ammoChargeMaterial;
    ...
    [Header("弹药散射")] public float ammoSpreadMin = 0f;
    public float ammoSpreadMax = 0f;

    [Header("每次生成的数量")] public int ammoSpawnAmountMin = 1;
    public int ammoSpawnAmountMax = 1;

    [Header("弹药生成间隔")] public float ammoSpawnIntervalMin = 0f;
    public float ammoSpawnIntervalMax = 0f;

    [Header("是否生成轨迹")] public bool isAmmoTrail = false;
    [Header("轨迹存在时间")] public float ammoTrailTime = 3f;
    ...
    private void OnValidate()
    {
        ...
        HelperUtilities.ValidateCheckPositiveRange(this, nameof(ammoSpawnIntervalMin), ammoSpawnIntervalMin, nameof(ammoSpawnIntervalMax), ammoSpawnIntervalMax,
            true);
